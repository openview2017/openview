...
@WebResource( path="/openview/api/v1/locations/{id}/", method="GET" )
public class GeneratedRoutingMethod11085291 implements HttpHandler {
	...
	public void handleRequest( HttpServerExchange exchange ) throws Exception {
		...
		try {
			final kikaha.urouting.api.Response response = instance.getLocationById( 
