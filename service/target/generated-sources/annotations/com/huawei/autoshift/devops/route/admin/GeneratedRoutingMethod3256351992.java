...
@WebResource( path="/openview/api/v1/apps/{id}/metrics/", method="PUT" )
public class GeneratedRoutingMethod3256351992 implements HttpHandler {
	...
	@Inject com.huawei.openview.devops.route.admin.AppMetricsResource instance;
	...
	public void handleRequest( HttpServerExchange exchange ) throws Exception {
		...
		try {
			final kikaha.urouting.api.Response response = instance.updateAppMetricsByAppId( 
			methodDataProvider.getPathParam( exchange, "id", java.lang.Long.class )
			,methodDataProvider.getBody( exchange, com.huawei.openview.devops.domain.admin.AppMetrics[].class, "application/json" )
			 );
