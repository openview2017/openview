...
@WebResource( path="/openview/api/v1/apps/{id}/blueprint/", method="GET" )
public class GeneratedRoutingMethod2675793825 implements HttpHandler {
	...
	public void handleRequest( HttpServerExchange exchange ) throws Exception {
		...
		try {
			final kikaha.urouting.api.Response response = instance.getAppBlueprintByAppID( 
