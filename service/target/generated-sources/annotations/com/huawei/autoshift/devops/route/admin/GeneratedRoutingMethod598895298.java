...
@WebResource( path="/openview/api/v1/apps/{id}/blueprint/edited_content/", method="GET" )
public class GeneratedRoutingMethod598895298 implements HttpHandler {
	...
	public void handleRequest( HttpServerExchange exchange ) throws Exception {
		...
		try {
			final kikaha.urouting.api.Response response = instance.getEditedContent( 
