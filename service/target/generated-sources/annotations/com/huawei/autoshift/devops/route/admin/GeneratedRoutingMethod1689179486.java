...
@WebResource( path="/openview/api/v1/apps/{id}/status/", method="PUT" )
public class GeneratedRoutingMethod1689179486 implements HttpHandler {
	...
	@Inject com.huawei.openview.devops.route.admin.AppStatusResource instance;
	...
	public void handleRequest( HttpServerExchange exchange ) throws Exception {
		...
		try {
			final kikaha.urouting.api.Response response = instance.updateAppStatusById( 
			methodDataProvider.getPathParam( exchange, "id", java.lang.Long.class )
			,methodDataProvider.getBody( exchange, com.huawei.openview.devops.domain.admin.AppStatus.class, "application/json" )
			 );
