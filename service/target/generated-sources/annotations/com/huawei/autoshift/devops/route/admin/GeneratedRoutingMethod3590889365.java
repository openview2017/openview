...
@WebResource( path="/openview/api/v1/apps/{id}/", method="DELETE" )
public class GeneratedRoutingMethod3590889365 implements HttpHandler {
	...
	public void handleRequest( HttpServerExchange exchange ) throws Exception {
		...
		try {
			final kikaha.urouting.api.Response response = instance.deleteAppById( 
