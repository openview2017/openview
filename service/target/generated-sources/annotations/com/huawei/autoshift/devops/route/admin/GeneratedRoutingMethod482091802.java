...
@WebResource( path="/openview/api/v1/apps/{app_id}/demand-profiles/{id}/config/", method="GET" )
public class GeneratedRoutingMethod482091802 implements HttpHandler {
	...
	public void handleRequest( HttpServerExchange exchange ) throws Exception {
		...
		try {
			final kikaha.urouting.api.Response response = instance.getDemandProfileConfig( 
