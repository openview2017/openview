...
@WebResource( path="/openview/api/v1/apps/{id}/blueprint/entry_point/", method="GET" )
public class GeneratedRoutingMethod2271220754 implements HttpHandler {
	...
	public void handleRequest( HttpServerExchange exchange ) throws Exception {
		...
		try {
			final kikaha.urouting.api.Response response = instance.getEntryPoint( 
