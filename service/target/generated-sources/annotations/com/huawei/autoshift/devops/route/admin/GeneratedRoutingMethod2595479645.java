...
@WebResource( path="/openview/api/v1/apps/{id}/metrics/", method="GET" )
public class GeneratedRoutingMethod2595479645 implements HttpHandler {
	...
	public void handleRequest( HttpServerExchange exchange ) throws Exception {
		...
		try {
			final kikaha.urouting.api.Response response = instance.findAppMetrices( 
			methodDataProvider.getPathParam( exchange, "id", java.lang.Long.class )
			,methodDataProvider.getQueryParam( exchange, "index", java.lang.String.class )
			 );
