...
@WebResource( path="/openview/api/v1/apps/{id}/", method="GET" )
public class GeneratedRoutingMethod2719920742 implements HttpHandler {
	...
	public void handleRequest( HttpServerExchange exchange ) throws Exception {
		...
		try {
			final kikaha.urouting.api.Response response = instance.getAppById( 
			methodDataProvider.getPathParam( exchange, "id", java.lang.Long.class )
			,methodDataProvider.getQueryParam( exchange, "detail", java.lang.Boolean.class )
			 );
