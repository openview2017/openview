...
@WebResource( path="/openview/api/v1/apps/{app_id}/actions/{action_id}/apply/", method="POST" )
public class GeneratedRoutingMethod138496697 implements HttpHandler {
	...
	public void handleRequest( HttpServerExchange exchange ) throws Exception {
		...
		try {
			final kikaha.urouting.api.Response response = instance.executeRemediationActionById( 
