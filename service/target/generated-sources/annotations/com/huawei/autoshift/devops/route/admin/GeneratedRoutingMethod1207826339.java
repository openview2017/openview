...
@WebResource( path="/openview/api/v1/apps/{app_id}/demand-profiles/{demand_id}/capacity-plans/{plan_id}/dryrun/{dryrun_id}/count/", method="GET" )
public class GeneratedRoutingMethod1207826339 implements HttpHandler {
	...
	public void handleRequest( HttpServerExchange exchange ) throws Exception {
		...
		try {
			final kikaha.urouting.api.Response response = instance.getAppStatus( 
