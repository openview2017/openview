...
@WebResource( path="/openview/api/v1/apps/{app_id}/actions/{action_id}/", method="PUT" )
public class GeneratedRoutingMethod3364345603 implements HttpHandler {
	...
	public void handleRequest( HttpServerExchange exchange ) throws Exception {
		...
		try {
			final kikaha.urouting.api.Response response = instance.updateRemediationActionById( 
