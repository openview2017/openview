...
@WebResource( path="/openview/api/v1/apps/{app_id}/demand-profiles/", method="GET" )
public class GeneratedRoutingMethod3859061372 implements HttpHandler {
	...
	public void handleRequest( HttpServerExchange exchange ) throws Exception {
		...
		try {
			final kikaha.urouting.api.Response response = instance.getDemandProfiles( 
