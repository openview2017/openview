...
@WebResource( path="/openview/api/v1/apps/{id}/sla/", method="PUT" )
public class GeneratedRoutingMethod4024588187 implements HttpHandler {
	...
	public void handleRequest( HttpServerExchange exchange ) throws Exception {
		...
		try {
			final kikaha.urouting.api.Response response = instance.updateAppSlaByAppId( 
			methodDataProvider.getPathParam( exchange, "id", java.lang.Long.class )
			,methodDataProvider.getBody( exchange, com.huawei.openview.devops.domain.admin.AppSla.class, "application/json" )
			 );
