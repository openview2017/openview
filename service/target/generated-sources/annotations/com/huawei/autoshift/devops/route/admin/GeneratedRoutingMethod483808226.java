...
@WebResource( path="/openview/api/v1/apps/{app_id}/demand-profiles/", method="POST" )
public class GeneratedRoutingMethod483808226 implements HttpHandler {
	...
	public void handleRequest( HttpServerExchange exchange ) throws Exception {
		...
		try {
			final kikaha.urouting.api.Response response = instance.createDemandProfile( 
