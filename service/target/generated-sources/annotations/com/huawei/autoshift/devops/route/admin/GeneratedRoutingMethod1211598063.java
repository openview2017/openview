...
@WebResource( path="/openview/api/v1/apps/", method="POST" )
public class GeneratedRoutingMethod1211598063 implements HttpHandler {
	...
	public void handleRequest( HttpServerExchange exchange ) throws Exception {
		...
		try {
			final kikaha.urouting.api.Response response = instance.createApp( 
