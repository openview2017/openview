...
@WebResource( path="/openview/api/v1/apps/{app_id}/actions/", method="PUT" )
public class GeneratedRoutingMethod381469569 implements HttpHandler {
	...
	public void handleRequest( HttpServerExchange exchange ) throws Exception {
		...
		try {
			final kikaha.urouting.api.Response response = instance.addRemediationActionsByAppId( 
