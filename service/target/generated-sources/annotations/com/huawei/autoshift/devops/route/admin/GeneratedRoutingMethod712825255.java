...
@WebResource( path="/openview/api/v1/apps/{app_id}/actions/{action_id}/", method="PATCH" )
public class GeneratedRoutingMethod712825255 implements HttpHandler {
	...
	public void handleRequest( HttpServerExchange exchange ) throws Exception {
		...
		try {
			final kikaha.urouting.api.Response response = instance.patchRemediationActionById( 
			...
			,methodDataProvider.getBody( exchange, com.huawei.openview.devops.domain.admin.RemediationAction.class, "application/json" )
			 );
