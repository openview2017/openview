...
@WebResource( path="/openview/api/v1/apps/{id}/blueprint/edited_content/", method="PUT" )
public class GeneratedRoutingMethod2247420177 implements HttpHandler {
	...
	public void handleRequest( HttpServerExchange exchange ) throws Exception {
		...
		try {
			final kikaha.urouting.api.Response response = instance.updateEditedContent( 
