...
@WebResource( path="/openview/api/v1/apps/{id}/launch/", method="POST" )
public class GeneratedRoutingMethod3658082184 implements HttpHandler {
	...
	public void handleRequest( HttpServerExchange exchange ) throws Exception {
		...
		try {
			final kikaha.urouting.api.Response response = instance.launchAppById( 
			methodDataProvider.getPathParam( exchange, "id", java.lang.Long.class )
			,methodDataProvider.getQueryParam( exchange, "capacity-plan-result-id", java.lang.Long.class )
			 );
