...
@WebResource( path="/openview/api/v1/apps/", method="GET" )
public class GeneratedRoutingMethod718425934 implements HttpHandler {
	...
	public void handleRequest( HttpServerExchange exchange ) throws Exception {
		...
		try {
			final kikaha.urouting.api.Response response = instance.getApps( 
			 );
