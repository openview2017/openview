...
@WebResource( path="/openview/api/v1/apps/{id}/blueprint/", method="PUT" )
public class GeneratedRoutingMethod1521639750 implements HttpHandler {
	...
	public void handleRequest( HttpServerExchange exchange ) throws Exception {
		...
		try {
			final kikaha.urouting.api.Response response = instance.updateAppBlueprintByAppID( 
			methodDataProvider.getPathParam( exchange, "id", java.lang.Long.class )
			,methodDataProvider.getBody( exchange, com.huawei.openview.devops.domain.admin.AppBlueprint.class, "application/json" )
			 );
