...
@WebResource( path="/openview/api/v1/apps/{id}/current-setconfigs/", method="GET" )
public class GeneratedRoutingMethod3460707768 implements HttpHandler {
	...
	public void handleRequest( HttpServerExchange exchange ) throws Exception {
		...
		try {
			final kikaha.urouting.api.Response response = instance.getCurrentSetConfigs( 
