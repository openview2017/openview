...
@WebResource( path="/openview/api/v1/apps/{app_id}/demand-profiles/{id}/config/", method="POST" )
public class GeneratedRoutingMethod2360484769 implements HttpHandler {
	...
	public void handleRequest( HttpServerExchange exchange ) throws Exception {
		...
		try {
			...
			final kikaha.urouting.api.Response response = instance.uploadDemandProfileConfig( 
			...
			,methodDataProvider.getFormParam( formData, "filename", java.lang.String.class )
			 );
