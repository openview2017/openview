...
@WebResource( path="/openview/api/v1/apps/{app_id}/demand-profiles/{id}/", method="PUT" )
public class GeneratedRoutingMethod3108529406 implements HttpHandler {
	...
	@Inject com.huawei.openview.devops.route.admin.DemandProfileResource instance;
	...
	public void handleRequest( HttpServerExchange exchange ) throws Exception {
		...
		try {
			final kikaha.urouting.api.Response response = instance.updateDemandProfileById( 
			...
			,methodDataProvider.getBody( exchange, com.huawei.openview.devops.domain.admin.DemandProfile.class, "application/json" )
			 );
