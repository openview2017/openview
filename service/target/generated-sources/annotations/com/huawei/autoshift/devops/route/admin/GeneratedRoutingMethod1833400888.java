...
@WebResource( path="/openview/api/v1/apps/{app_id}/actions/{action_id}/", method="GET" )
public class GeneratedRoutingMethod1833400888 implements HttpHandler {
	...
	public void handleRequest( HttpServerExchange exchange ) throws Exception {
		...
		try {
			final kikaha.urouting.api.Response response = instance.findRemediationActionById( 
