...
@WebResource( path="/openview/api/v1/apps/{app_id}/demand-profiles/{demand_id}/all-merged/", method="GET" )
public class GeneratedRoutingMethod1951549121 implements HttpHandler {
	...
	@Inject com.huawei.openview.devops.route.admin.CapacityPlanAllMergedResource instance;
	...
	public void handleRequest( HttpServerExchange exchange ) throws Exception {
		...
		try {
			final kikaha.urouting.api.Response response = instance.getAll( 
