...
@WebResource( path="/openview/api/v1/apps/{app_id}/demand-profiles/{id}/config/", method="PUT" )
public class GeneratedRoutingMethod3153470049 implements HttpHandler {
	...
	public void handleRequest( HttpServerExchange exchange ) throws Exception {
		...
		try {
			final kikaha.urouting.api.Response response = instance.updateDemandProfileConfig( 
			...
			,methodDataProvider.getBody( exchange, java.lang.String.class, "application/json" )
			 );
