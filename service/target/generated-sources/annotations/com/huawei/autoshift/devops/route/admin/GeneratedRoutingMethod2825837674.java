...
@WebResource( path="/openview/api/v1/apps/{app_id}/actions/", method="POST" )
public class GeneratedRoutingMethod2825837674 implements HttpHandler {
	...
	public void handleRequest( HttpServerExchange exchange ) throws Exception {
		...
		try {
			final kikaha.urouting.api.Response response = instance.updateRemediationActionsByAppId( 
