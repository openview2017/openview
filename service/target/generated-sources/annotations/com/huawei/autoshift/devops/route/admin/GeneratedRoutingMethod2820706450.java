...
@WebResource( path="/openview/api/v1/apps/{id}/blueprint/original_content/", method="GET" )
public class GeneratedRoutingMethod2820706450 implements HttpHandler {
	...
	public void handleRequest( HttpServerExchange exchange ) throws Exception {
		...
		try {
			final kikaha.urouting.api.Response response = instance.getOriginalContent( 
