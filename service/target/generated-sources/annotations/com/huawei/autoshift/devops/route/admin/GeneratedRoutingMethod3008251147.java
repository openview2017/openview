...
@WebResource( path="/openview/api/v1/apps/{app_id}/demand-profiles/{id}/", method="GET" )
public class GeneratedRoutingMethod3008251147 implements HttpHandler {
	...
	public void handleRequest( HttpServerExchange exchange ) throws Exception {
		...
		try {
			final kikaha.urouting.api.Response response = instance.getDemandProfileById( 
