...
@WebResource( path="/openview/api/v1/apps/{id}/blueprint/original_content/", method="PUT" )
public class GeneratedRoutingMethod4282448673 implements HttpHandler {
	...
	public void handleRequest( HttpServerExchange exchange ) throws Exception {
		...
		try {
			final kikaha.urouting.api.Response response = instance.updateOriginalContent( 
