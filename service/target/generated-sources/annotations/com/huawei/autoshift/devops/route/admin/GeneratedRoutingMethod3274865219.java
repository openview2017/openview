...
@WebResource( path="/openview/api/v1/apps/{id}/blueprint/entry_point/", method="PUT" )
public class GeneratedRoutingMethod3274865219 implements HttpHandler {
	...
	public void handleRequest( HttpServerExchange exchange ) throws Exception {
		...
		try {
			final kikaha.urouting.api.Response response = instance.updateEntryPoint( 
