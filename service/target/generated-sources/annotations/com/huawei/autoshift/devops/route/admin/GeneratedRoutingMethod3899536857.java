...
@WebResource( path="/openview/api/v1/apps/{app_id}/demand-profiles/{id}/", method="DELETE" )
public class GeneratedRoutingMethod3899536857 implements HttpHandler {
	...
	public void handleRequest( HttpServerExchange exchange ) throws Exception {
		...
		try {
			final kikaha.urouting.api.Response response = instance.deleteDemandProfileById( 
