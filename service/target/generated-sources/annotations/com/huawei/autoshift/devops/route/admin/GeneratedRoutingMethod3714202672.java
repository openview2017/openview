...
@WebResource( path="/openview/api/v1/apps/{id}/sla/", method="GET" )
public class GeneratedRoutingMethod3714202672 implements HttpHandler {
	...
	@Inject com.huawei.openview.devops.route.admin.AppSlaResource instance;
	...
	public void handleRequest( HttpServerExchange exchange ) throws Exception {
		...
		try {
			final kikaha.urouting.api.Response response = instance.findAppSlaByAppId( 
