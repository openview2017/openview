...
@WebResource( path="/openview/api/v1/apps/{id}/applicationmode/", method="GET" )
public class GeneratedRoutingMethod3165652956 implements HttpHandler {
	...
	public void handleRequest( HttpServerExchange exchange ) throws Exception {
		...
		try {
			final kikaha.urouting.api.Response response = instance.findAppModeByAppId( 
