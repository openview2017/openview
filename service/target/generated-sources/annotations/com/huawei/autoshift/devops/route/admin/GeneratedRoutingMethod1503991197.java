...
@WebResource( path="/openview/api/v1/apps/{id}/status/", method="GET" )
public class GeneratedRoutingMethod1503991197 implements HttpHandler {
	...
	public void handleRequest( HttpServerExchange exchange ) throws Exception {
		...
		try {
			final kikaha.urouting.api.Response response = instance.findAppStatusById( 
