...
@WebResource( path="/openview/api/v1/locations/", method="POST" )
public class GeneratedRoutingMethod3284867941 implements HttpHandler {
	...
	public void handleRequest( HttpServerExchange exchange ) throws Exception {
		...
		try {
			final kikaha.urouting.api.Response response = instance.createLocation( 
